...
int main (void)
{
    ...
    typedef itk::Vector< unsigned char, DataDimension > DataType; // Data type for the points in the image

    typedef itk::PointSet< DataType, ParametricDimension >   PointSetType; //Dimension of the values at each point

    PointSetType::Pointer pointSet = PointSetType::New(); //Point Set
